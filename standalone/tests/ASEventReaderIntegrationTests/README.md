# ASEventReader Integration Tests

Integration tests for the ASEventReader project that test against real ETL and ZIP files.
...
dotnet test tests/ASEventReaderIntegrationTests/ASEventReaderIntegrationTests.csproj
```
...
- **ASEventReader** - Main project (project reference)
