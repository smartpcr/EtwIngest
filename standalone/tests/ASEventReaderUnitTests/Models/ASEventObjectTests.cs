//-----------------------------------------------------------------------
// <copyright file="ASEventObjectTests.cs" company="Microsoft Corp.">
...
namespace ASEventReaderUnitTests.Models
{
    ...
    /// <summary>
    /// Unit tests for ASEventObject class.
    /// </summary>
    [TestClass]
    public class ASEventObjectTests
    {
        /// <summary>
        /// Tests that a new ASEventObject has default values.
        /// </summary>
        [TestMethod]
        public void Constructor_CreatesObjectWithDefaults()
        {
            // Arrange & Act
            var evt = new ASEventObject();
        ...
        {
            // Arrange
            var parent = new ASEventObject();
            var child = new ASEventObject();
        ...
        public void AddChild_MultipleChildren_UpdatesIsLastSibling()
        {
            // Arrange
            var parent = new ASEventObject();
            var child1 = new ASEventObject();
            var child2 = new ASEventObject();
