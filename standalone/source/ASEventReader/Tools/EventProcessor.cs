...
namespace ASEventReader.Tools
{
    ...
    public class EventProcessor
    {
        ...
        /// <returns>List of ASEventObject instances.</returns>
        public List<ASEventObject> GetEvents(
            string[] paths,
            ...
            string? eventName = null)
        {
            try
            {
                ...
                var allEvents = new List<ASEventObject>();
                var wrapper = new ASEventWrapper();
        ...
        private void ProcessLogFile(
            string file,
            List<ASEventObject> eventList,
            ASEventWrapper wrapper,
            Guid activityId,
            string? providerName,
            string? eventName)
        {
            Action<TraceEvent> action = data =>
            {
                if (data.EventName != EventNames.ManifestEventName)
                {
                    ...
                    // Wrap the ETW event.
                    ASEventObject wrappedEvent = wrapper.CreateFromTraceEvent(data);
        ...
        /// <param name="wrapper">Instance of ASEventWrapper.</param>
        /// <param name="providerName">Provider name filter.</param>
        /// <param name="eventName">Event name filter.</param>
            ...
            string? eventName)
        {
            ...
            {
                ASEventObject wrappedEvent = wrapper.CreateFromTraceEvent(traceEvent);
                eventList.Add(wrappedEvent);
            }
        }
