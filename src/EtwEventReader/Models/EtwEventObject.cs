//-----------------------------------------------------------------------
// <copyright file="EtwEventObject.cs" company="Microsoft Corp.">
...
namespace EtwEventReader.Models
{
    ...
    public class EtwEventObject
    {
        ...
        /// </summary>
        private EtwEventObject? lastSiblingObject;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EtwEventObject"/> class.
        /// </summary>
        public EtwEventObject()
        {
        ...
        /// </summary>
        public EtwEventObject? Parent { get; private set; }
        ...
        public void AddChild(EtwEventObject child)
        {
